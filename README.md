...
###### Description
A predefined deployment workflow that complements the [Oracle Action Pack](https://github.com/Automic-Community/oracle-action-pack) 


###### Actions
 
 1.  Template Oracle DB  Install
 2.  Template Oracle DB  Uninstall
